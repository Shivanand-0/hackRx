...
async def run_submission(request: HackRxRequest):
    ...
    await rag_service.process_and_index_document(doc_url=request.documents, namespace=namespace)

    # Create concurrent tasks for answering questions
    tasks = [rag_service.get_answer(question=q, namespace=namespace) for q in request.questions]
